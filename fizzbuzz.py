...
printfizz = int(input("For multiples of what number shall we print 'Fizz'? "))
printbuzz = int(input("For multiples of what number shall we print 'Buzz'? "))

nums = range(1,(numbers + 1))
for x in nums:
    if x % printfizz == 0 and x % printbuzz == 0:
        print("FizzBuzz")
    else:
        if x % printfizz == 0:
            print("Fizz")
